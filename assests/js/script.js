...
const displayDaysForcast = dataDays => {
  ...
  let dataDayTwo = dataDays.list[6];
  ...
  let dataDayThree = dataDays.list[14];
  ...
  let dataDayFour = dataDays.list[22];
  ...
  let dataDayFive = dataDays.list[30];
